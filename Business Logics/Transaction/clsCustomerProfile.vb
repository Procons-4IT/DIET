                            ...
                            Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_LOAD
                                If BusinessObjectInfo.ActionSuccess Then
                                    ...
                                    For index As Integer = 1 To oMatrix.VisualRowCount
                                        ...
                                        End If
                                    Next
                                    'Dim oColumn As SAPbouiCOM.Column = oMatrix.Columns.Item("V_0")
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_ADD, _
                                ...
                                If BusinessObjectInfo.ActionSuccess Then
                                    ...
                                    Try
                                        ...
                                        Try
                                            CType(oLoadForm.Items.Item("4").Specific, SAPbouiCOM.StaticText).Caption = "Removing Customer Exclude Dates..."
                                            oApplication.Utilities.removeExcludeDocumentRow(strCardCode, strDocEntry) 'Remove Future Exclude...Dates
                                        Catch ex As Exception
                                            oApplication.Log.Trace_DIET_AddOn_Error(ex)
                                        End Try
...
#Region "Function"
    ...
    Private Sub disablecell(ByVal oForm As SAPbouiCOM.Form)
        Try
            oForm.Freeze(True)
            oMatrix = oForm.Items.Item("6").Specific
            For index As Integer = 1 To oMatrix.VisualRowCount
